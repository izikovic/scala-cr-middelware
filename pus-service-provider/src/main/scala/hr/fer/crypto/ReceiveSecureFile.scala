...
object ReceiveSecureFile extends App {
  ...
  receiveFile(privateKeyFile, publicKeyFile, inputFile, outputFile)

  def receiveFile(privateKeyFile: String, publicKeyFile: String, inputFile: String, outputFile: String) {
